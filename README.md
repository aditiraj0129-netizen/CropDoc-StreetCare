...
Early detection prevents 60-70% of crop losses. A farmer who catches Late Blight three days earlier saves the harvest. A citizen who knows that the dog on their street has tick fever and pale gums — not just "looks sick" — can make the difference between that animal surviving or not.

The SMS fallback reaches the 40% of Indian farmers who don't have smartphones. That was a deliberate choice, not an afterthought.

---

Built by **Aditi Singh** · June 2026

*Everything in this repo was written, debugged, trained, and deployed from scratch. Total cloud cost: ₹0.*
